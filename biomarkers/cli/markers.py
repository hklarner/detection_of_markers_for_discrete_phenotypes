...
@click.option("-m", "fname_markers", nargs=1, default="markers.json", show_default=True, help="Name of markers file.")
...
def markers_info(fname_markers: str, fname_csv: str, enable_header: bool):
    """
    ...
    print(f"markers.component_names={markers.component_names}")
    print(f"len(markers.indices)={len(markers.indices)}")
    print(f"markers.unique_indices()={markers.unique_indices()}")
